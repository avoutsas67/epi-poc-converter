...
class DataBetweenHeadingsExtractor:
    ...
    def __init__(self, logger, matched_collection, procedureType, languageCode):
    ...
    def extractContentBetweenHeadings(self, input_filename):
        ...
        path_partition_json = os.path.join(os.path.abspath(os.path.join('..')), 'data', 'partitionedJSONs', f'{self.procedureType}', f'{self.languageCode}')
