class FhirXmlGenerator:
    ...
    def createImgRef(self, html, img_ref_dict):
        ...
        """
        self.logger.debug('Processing Images To Inject In <contained>')
        ...
        self.logger.debug('Finished Processing Images')
    ...
    def generateXml(self, df, template, xml_output_path):
        xml_file_name = 'ePI_output_template.xml'
